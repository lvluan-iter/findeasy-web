<template>
  <div class="min-h-screen bg-slate-100 dark:bg-slate-900">
    <div v-show="isMobileMenuOpen" class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm z-40 lg:hidden"
    ...
    <aside :class="[
      ...
      <div class="flex items-center gap-2 px-6 py-5 border-b border-white/10">
        <img src="@/assets/images/logo.png" alt="FindEasy" class="h-8">
      </div>
      ...
      <div class="absolute bottom-0 left-0 right-0 p-4">
        <div class="flex items-center gap-3 p-3 rounded-xl bg-white/10 backdrop-blur-sm">
          <img src="@/assets/images/avatar.jpg" class="w-10 h-10 rounded-lg object-cover">
          ...
          <button class="p-1.5 rounded-lg hover:bg-white/10" @click="router.push('/')">
    ...
    <div :class="[
      ...
      <header
        class="sticky top-0 z-30 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-b border-slate-200 dark:border-slate-700">
        <div class="flex items-center justify-between h-16 px-4 lg:px-6">
          <div class="flex items-center gap-4">
            <button class="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 lg:hidden"
          ...
          <div class="flex items-center gap-3">
            <div class="relative hidden lg:block">
              <input type="text" placeholder="Tìm kiếm..." class="w-72 pl-10 pr-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-700 border-0 
            ...
            <div class="flex items-center gap-2">
              ...
              <button class="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700" @click="toggleDarkMode">
                <i :class="[
                  'fas',
      ...
      <main class="flex-1 p-4 lg:p-6">
        <router-view v-slot="{ Component }">
          <transition name="fade" mode="out-in" enter-active-class="transition-all duration-300 ease-out"
