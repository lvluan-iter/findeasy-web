      ...
      <div class="bg-gradient-to-br from-slate-50 to-slate-100 shadow-2xl rounded-3xl overflow-hidden">
        <div class="relative">
          <div class="absolute inset-0 bg-indigo-100 opacity-50">
            ...
            >
              <path d="M0 0h80v80H0z" fill="#667eea" fill-opacity=".1" />
              <path d="M80 0L0 80M80 80L0 0" stroke="#667eea" stroke-width="1" stroke-opacity=".1" />
            </svg>
          </div>
            ...
            <div class="w-full md:w-2/3 p-8 flex flex-col justify-between bg-white bg-opacity-90 backdrop-blur-sm">
              <div>
                ...
                <div class="grid grid-cols-3 gap-6 mb-8">
                  <div v-for="(stat, index) in stats" :key="index" class="text-center p-4 bg-indigo-50 rounded-xl">
                ...
                <div class="flex space-x-4 mb-8">
                  ...
                  >
                    <i :class="action.icon" class="mr-2" />
                    {{ action.label }}
                  </button>
                </div>
              </div>
              ...
              <div class="border-t border-gray-200 pt-6">
                <dl class="grid grid-cols-2 gap-x-6 gap-y-4 text-sm">
                  <div v-for="(detail, index) in details" :key="index" class="flex items-center">
