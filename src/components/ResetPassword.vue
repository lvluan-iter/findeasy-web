    ...
    <div>
        ...
        <div
            ...
            <span class="text-gray-600">Fill with your mail to receive instructions on how to reset your
                password.</span>
            <form @submit.prevent="handleResetPasswordSubmit" class="mt-5">
                <div class="form-group relative mb-5 text-left animate-fade-in-up">
                    ...
                    <input
                        ...
                        type="password" v-model="newPassword" @focus="isFocusedNewPassword = true"
                        @blur="isFocusedNewPassword = false" required>
                </div>
                <button
