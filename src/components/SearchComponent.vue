  ...
  <div class="bg-gradient-to-br from-gray-50 to-blue-50 px-4 sm:px-6 md:px-12 lg:px-[120px] py-12">
    <div class="max-w-7xl mx-auto">
      <div class="flex items-center">
        ...
        <h1 class="ml-4 text-3xl font-bold text-gray-800">
        ...
        <div class="p-8">
          ...
          <div class="mb-8">
            <div class="relative group">
              <i class="fas fa-search absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-400 group-focus-within:text-blue-600 transition duration-300" />
              <input
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="relative group">
              <i class="fas fa-map-marker-alt absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-400 group-focus-within:text-blue-600 transition duration-300" />
              <input
            ...
            <div class="relative group">
              <i class="fas fa-home absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-400 group-focus-within:text-blue-600 transition duration-300" />
              <select
              ...
              <i class="fas fa-chevron-down absolute right-4 top-1/2 transform -translate-y-1/2 text-blue-400 pointer-events-none" />
            </div>

            <div class="relative group">
              <i class="fas fa-city absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-400 group-focus-within:text-blue-600 transition duration-300" />
              <select
      ...
      <div 
        v-if="errorMessage"
        class="text-red-500 mt-6 text-center"
      >
        {{ errorMessage }}
      </div>
    </div>
...
const search = async () => {
  try {
    ...
    Object.keys(searchData).forEach(key => 
      (searchData[key] === null || searchData[key] === '' || 
