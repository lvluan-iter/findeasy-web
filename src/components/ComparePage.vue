<template>
  <div class="bg-gray-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
          ...
          <div class="p-6">
            ...
            <div class="overflow-x-auto">
              <table class="w-full">
                <thead>
                  <tr class="bg-blue-50">
                    <th class="p-3 text-left text-blue-600 font-medium">
                      Tiêu chí
                    </th>
                    <th
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <template v-else>
                          {{ property[feature.key] }} {{ feature.unit }}
                        </template>
                      </td>
                    </tr>
                  </template>
      ...
      <div
        v-else
        class="text-center text-gray-500 text-xl bg-white p-8 rounded-lg shadow-md"
      >
...
const featureGroups = [
  ...
  },
  {
    name: 'Đánh giá',
    features: [
      { name: 'Xếp hạng', key: 'rating', type: 'rating', icon: 'fas fa-star' },
    ]
  }
];
</script>
