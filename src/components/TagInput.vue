<template>
  <div class="relative group">
    ...
    <div
      class="flex flex-wrap items-center gap-2 w-full pl-10 pr-3 py-2 text-sm border-b border-gray-300 focus-within:border-blue-500 transition duration-300 bg-transparent"
    >
      <div
      ...
      >
        {{ tag }}
        <button class="text-xs text-blue-500 hover:text-red-500 transition duration-300" @click="removeTag(index)">
