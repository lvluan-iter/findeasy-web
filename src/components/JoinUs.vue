  ...
  >
    <div class="max-w-3xl mx-auto">
      <div class="mb-8 sm:mb-12">
        <span class="inline-block px-4 py-2 bg-white rounded-full text-[#0a73c0] text-sm mb-4"
          >Our Latest Articles</span
        >
        <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">Want To Join Us?</h2>
        <p class="text-white text-sm sm:text-base md:text-lg">
          Sign up to never miss important news, articles, and updates from us.
        </p>
      </div>
      ...
      <p class="text-white text-xs sm:text-sm">
        Rest assured, all of our latest updates and news <br class="hidden sm:inline" />will be delivered to you
        swiftly!
      </p>
    </div>
  </div>
...
const subscribe = () => {
  alert(`Thank you, ${fullName.value}! You've been subscribed`);
};
</script>
