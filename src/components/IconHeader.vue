<template>
  ...
  >
    <div 
      class="flex gap-2.5 items-center text-white text-2xl md:text-3xl cursor-pointer"
      @click="goToHome"
    >
      ...
      >
        ...
        >
          <div class="flex items-center justify-between">
            ...
            <div
              class="h-full w-10 flex items-center justify-end text-[#2f2e41]"
              @click="toggleDropdown"
            >
