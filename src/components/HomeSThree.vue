  ...
  <div class="px-4 sm:px-6 md:px-8 lg:px-[120px]">
    <div class="text-center mb-[50px]">
      ...
      <p class="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[calc(1.375rem+1.5vw)] text-[#212529] m-0 mb-5">
        Explore Our Top Featured Properties
      </p>
      <span class="description-text text-sm sm:text-base">
        Discover the best properties currently available on the market. From luxurious homes to prime commercial spaces, our featured listings showcase exceptional opportunities for buyers and investors. Browse through our top selections and find your ideal property today.
      </span>
    </div>
    <AvaibleProperty 
