<template>
  <div class="px-4 sm:px-6 md:px-12 lg:px-[120px]">
    <header class="text-center mb-8 md:mb-[50px]">
      <div class="inline-block py-1.5 px-4 sm:py-2 sm:px-5 bg-[rgba(10,115,192,0.08)] rounded-full text-[#0a73c0] mb-2">
        Nền Tảng Đăng Tin
      </div>
      ...
      <p class="text-[#707070]">
        ...
        Khi đăng tin với chúng tôi, bạn sẽ có quyền truy cập vào một nền tảng mạnh mẽ, dễ dàng quản lý và cập nhật các tin rao, đồng thời tiếp cận hàng triệu người mua tiềm năng.
        <br>
        <strong>Bắt đầu ngay hôm nay</strong> để mở rộng phạm vi tiếp cận của bạn và thu hút thêm nhiều khách hàng!
      </p>
    </header>
    <div class="grid grid-cols-1 sm:grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-4">
      <div class="p-6 sm:p-8 md:p-10 bg-[#0a73c0] rounded-lg text-white">
        ...
        <p>
          Đăng tin bất động sản của bạn với chúng tôi và tiếp cận lượng lớn người mua tiềm năng. 
          Tận hưởng những tiện ích của nền tảng để dễ dàng quản lý và cập nhật các tin đăng của bạn.
        </p>
      ...
      <div class="p-6 sm:p-8 md:p-10 bg-[#212529] rounded-lg text-white">
        ...
        <p>
          Nâng cao tầm nhìn cho bất động sản của bạn với tin đăng VIP. Được ưu tiên vị trí, tính năng nổi bật và gia tăng độ tiếp cận để thu hút nhiều người mua tiềm năng hơn. 
          Hãy nổi bật và làm cho bất động sản của bạn tỏa sáng!
        </p>
