  ...
  <div class="py-[60px] bg-[#212529]">
    <div class="mb-14 px-4 sm:px-6 md:px-8 lg:px-[120px]">
      ...
      <span class="text-white"
        >Our guests always enjoy unique stays around the world.<br />
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5 items-center px-3">
      ...
      >
        <img :src="image.url" class="w-full h-full object-cover" :alt="`Gallery image ${index + 1}`" />
        <div
    ...
    <div v-if="lightboxOpen" class="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center">
      <button class="absolute top-4 right-4 text-white text-4xl" @click="closeLightbox">&times;</button>
