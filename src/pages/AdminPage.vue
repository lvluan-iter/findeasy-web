      ...
      <div class="absolute bottom-0 left-0 right-0 p-4">
        <div class="flex items-center gap-3 p-3 rounded-xl bg-white/10 backdrop-blur-sm">
          ...
          <div class="flex-1 min-w-0">
            <h3 class="text-sm font-semibold text-white truncate">Lê Văn Luân</h3>
          ...
          <div class="flex items-center gap-3">
            <div class="relative hidden lg:block">
              <input
                ...
                class="w-72 pl-10 pr-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-700 border-0 focus:ring-2 focus:ring-[rgb(10,115,192)] dark:text-slate-100 placeholder-slate-500 dark:placeholder-slate-400"
              />
            ...
            <div class="flex items-center gap-2">
              ...
              <button class="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700" @click="toggleDarkMode">
                <i :class="['fas', isDarkMode ? 'fa-sun' : 'fa-moon', 'text-slate-600 dark:text-slate-300']" />
              </button>
            </div>
          </div>
        </div>
